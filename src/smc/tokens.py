...
OPCODE_SYNONYMS: dict[Opcode, list[str]] = {
    Opcode.EXPERIMENT: [
        "EXPERIMENT", "PROGRAM", "MODULE", "SECRET_LAB", "LAB_EXPERIMENT", "DEXTER_LAB_EXPERIMENT", "OMNITRIX_INIT"
    ],
    Opcode.SET_VAR: [
        "LET", "SET", "VAR", "SUGAR", "SPICE", "EVERYTHING_NICE", "CHEMICAL_X", "FORMULA_X"
    ],
    Opcode.TTL_BOX: [
        "ACME", "ACME_BOX", "ACME_ANVIL_BOX", "EPHEMERAL", "ANVIL_BOX", "DISPOSABLE_VAR", "TTL_VAR"
    ],
    Opcode.IF: [
    ...
    Opcode.SUMMON: [
        "BIND", "SUMMON", "RING_BIND", "ELEMENT_BIND", "PLANET_POWER", "SUMMON_PLANETEER", "CAPTAIN_PLANET"
    ],
    Opcode.CALL_RING: [
        "DISPATCH", "CALL", "INVOKE_RING", "RING_CALL", "EMIT_EVENT", "POWERS_COMBINED", "I_CHOOSE_YOU"
    ],
    Opcode.TRANSFORM: [
        "MPP", "TRANSFORM", "EVOLVE", "MORPH", "DIFFERENTIATE", "POWER_UP", "MOON_PRISM_POWER", "SAILOR_TRANSFORM"
    ],
    Opcode.FALLBACK: [
        "FALLBACK", "WATCHDOG", "SAFETY_NET", "CATCH", "DEFAULT_HANDLER", "TUXEDO_MASK", "ROSE_THROW"
    ],
    Opcode.PRINT: [
        "PRINT", "EMIT", "SAY", "SHOUT", "KAMEHAMEHA", "HADOUKEN", "COWABUNGA_NEWS"
    ],
    Opcode.MUTATE: [
        "MUTATE", "MUTATION", "CHAOS_TEST", "FAULT_INJECT", "OOPS_MUTATION", "DEE_DEE_MUTATION", "RADIOACTIVE_SPIDER"
    ],
    Opcode.IMPORT: [
